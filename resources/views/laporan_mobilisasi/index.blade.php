...
@section('title')
    Historical Mobilisasi
@endsection

@section('breadcrumb')
    @parent
    <li class="active">Historical Mobilisasi</li>
@endsection

@section('content')
<ul class="nav nav-tabs">
    <li role="presentation" class="active"> <a href="{{ route('mobilisasi.report') }}">
        <span>History Mobilisasi</span>
    </a></li>
</ul>
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="box-body">
                <form action="" class="form-kode-kendaraan">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="kode_produk" class="col-lg-2">Lokasi</label>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="input-group">
                                    <select class="form-control" id="lokasi" name="lokasi">
                                        <option selected value="Semua Data">Semua Data</option>
                            ...
                            <div class="col-md-2">
                                <button  class="btn btn-danger btn-flat" type="button" onclick="notaBesar('Laporan Mobilisasi')" id="cari">Cetak PDF</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    // // function cari_otomatis(){
        ...
        $(function() {
                ...
                autoWidth: false,
                ajax: {
                url: '{{ route('mobilisasi.getAll') }}',
                },
                columns: [
                    {data: 'kode_mobilisasi', searchable: false, sortable: false},
                    {data: 'kode_kabin'},
                    {data: 'nopol'},
                    {data: 'lokasi'},
                    {data: 'user'},
    ...
    $("#cari").on("click", function (event) {
        ...
        if(!tanggal_awal || !tanggal_akhir){
            ...
            table.ajax.url("/report/data/"+id + '/' + tanggal_awal + '/' + tanggal_akhir);
            table.ajax.reload();
        }
        });
    ...
    function notaBesar(title) {
        ...
        if(!tanggal_awal || !tanggal_akhir){
            ...
            let url = "/report/cetak/"+id+'/'+tanggal_awal+'/'+tanggal_akhir;
