<div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-labelledby="modal-form">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{route('penerimaan_detail.update')}}" method="post" class="form-horizontal">
            @csrf
            @method('post');
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <div class="form-group row">
                        <label for="user" class="col-lg-2 col-lg-offset-1 control-label">Kode Barang</label>
                        <div class="col-lg-6">
                        <input type="text" name="kode_barang" id="kode_barang" class="form-control datepicker"
                                style="border-radius: 0 !important;" readonly>
